...
def export():
    ...
    torch.jit.save(traced, opt.filename)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', type=str, default='cpu', help='device to run model on (this must be specified at export time)')
    parser.add_argument('--filename', type=str, default='yolov3-spp.pt', help='exported file path')
